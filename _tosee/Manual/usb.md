...
| 1. 요청 내용을 입력후 USB 사용 로그기록 확인 동의를 체크후 승인요청 버튼을 누른다. <br> 2. USB 사용 로그기록 확인 동의는 사용자가 USB에서 작업한 내용의 로그를 담당자에게 전송한다.<br> - 현재는 로그만 남기고 있음(ver 2.4) <br> 3. 담당자의 허가 또는 차단등의 처리가 올때까지 대기한다.|
